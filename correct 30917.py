...
fin = open("makets_12-21/Gelicon_SES_2022029.30917")
...
#код "счетчика" потерь на трансформаторе

line17_list[0] = '(84014715111)'

#обновление списка: удаление ночной генерации
for i in range(2, l2):
    if (((1 < i <= 15) or (36 <= i <= 49)) and (line2_list[i] != 0)):
        line2_list[20] = line2_list[20] + line2_list[i]
        line2_list[i] = 0.0
print(line2_list)

for j in range(2, l6):
    if (((1 < j <= 15) or (36 <= j <= 49)) and (line6_list[j] != 0)):
        line6_list[20] = line6_list[20] + line6_list[j]
        line6_list[j] = 0.0
print(line6_list)
...
print(makestring2)
makestring6 = ':'.join(map(str, line6_list))
print(makestring6)
...
fout = open("Gelicon_SES_2022029.30917", "wt")
for line in fin:
    fout.write(line.replace('.', ','))
fin.close()
fout.close()